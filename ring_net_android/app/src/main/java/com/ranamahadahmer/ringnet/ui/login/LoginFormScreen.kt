...
@Composable
fun LoginTextField(icon: ImageVector, placeHolder: String) {
...
fun LoginFormScreen(modifier: Modifier = Modifier) {
    ...
    Scaffold(modifier = modifier
            .fillMaxSize().scrollable(scroll, orientation = Orientation.Vertical)
    ) {
        Column(
            modifier = Modifier
                    .fillMaxSize()
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                LoginTextField(Icons.Outlined.Email, "Enter your Email")
            }
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                Text("Password", color = Color.Black, fontWeight = FontWeight.Bold)
                LoginTextField(Icons.Outlined.Lock, "Enter your password")
            }
