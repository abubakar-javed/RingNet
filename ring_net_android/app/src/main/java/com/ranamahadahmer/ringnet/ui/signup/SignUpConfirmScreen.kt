...
@Composable
fun SignUpConfirmScreen(modifier: Modifier = Modifier) {
    ...
    Scaffold(modifier = modifier
        ...
        Column(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                CustomTextField(Icons.Outlined.AttachEmail, "OTP", type = TextFieldType.Name, trailing = {Text("Optional", color = Color.Gray)})
            }
...
@Composable
fun PreviewSignUpConfirmScreen() {
    SignUpConfirmScreen()
}